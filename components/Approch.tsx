      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-5 text-white">
        ...
        >
          <CanvasRevealEffect
            ...
            containerClassName="bg-emerald-900 rounded overflow-hidden"
          />
        </Card>
        <Card
        ...
        >
          <CanvasRevealEffect
            ...
            containerClassName="bg-pink-900 rounded overflow-hidden"
            colors={[
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-sky-600 rounded overflow-hidden"
            colors={[[125, 211, 252]]}
          />
        </Card>
      </div>
  ...
  return (
    <div
      ...
      className="border group/canvas-card flex items-center justify-center
       border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded"
      style={{
        //   add these two
