...
const Conect = () => {
  return (
    <div className="flex-1 border border-white/[0.2] flex flex-col items-start p-4 relative h-[20rem] w-full overflow-visible">
      ...
      <CardSpotlight className="flex flex-col justify-center items-center w-full">
        <p className="text-xl font-bold relative z-20 mt-2 text-white w-full">
          Connect With Me
        </p>
        <div className="mt-5 gap-2 flex flex-1 flex-col text-white-100 items-start z-20 relative w-full">
          ...
          <a href="https://github.com/parvajio">
            <p className="flex items-center gap-2 btn">
              <svg
                className="h-5 w-5 bg-white-100 rounded-full"
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
                width="100"
